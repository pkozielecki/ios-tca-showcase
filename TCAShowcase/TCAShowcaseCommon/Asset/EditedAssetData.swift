...
public struct EditedAssetData: Hashable, Identifiable {
    /// An asset id.
...
public extension EditedAssetData {
...
extension EditedAssetData.Position: Identifiable {
